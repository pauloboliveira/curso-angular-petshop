...
export class MaskDirective {
    ...
    //Serviço que ouve o componente que está usando ele. 
    //ao colocar 'input', estou informando que só ouvirei o component que for input
    @HostListener('input', ['$event']) onInputChange(event) {
        ...
        //retira todos os caracteres que não são de 0 a 9
